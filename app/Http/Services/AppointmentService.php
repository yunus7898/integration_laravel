        ...
        try {
            ...
            if (is_null($appointment)) {
                return new ServiceResponse(
                    false,
                    '
                    L\'utilisateur n\'a pas la permission d\'annuler le rendez-vous'
                );
            }
    ...
    public function confirm(int $appointmentId)
    {
        try {
            ...
            if ($user->type !== 'admin') {
                return new ServiceResponse(
                    false,
                    'L\'utilisateur n\'a pas la permission de confirmer le rendez-vous'
                );
            }
            ...
            return new ServiceResponse(
                false,
                'Erreur de confirmation de rendez-vous',
                null,
                $th
            );
        }
        ...
        try {
            ...
            if (is_null($appointment)) {
                return new ServiceResponse(
                    false,
                    '
                    L\'utilisateur n\'a pas la permission de supprimer le programme'
                );
            }
...
'Planifier avec succès la suppression',
            $appointment
        );
    }
}
