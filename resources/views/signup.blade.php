...
S'inscrire</h3>
                                    <form action="{{ route('signup') }}" method="post">
                                        ...
                                        <div class="input-group mb-4">
                                            <input type="password" class="form-control" name="password_confirmation" placeholder="Confimar password">
                                        </div>
                                        <button type="submit" class="btn btn-primary shadow-2 mb-4">
S'inscrire</button>
                                    </form>
                                    <p class="mb-0 text-muted">Vous avez déjà un compte ? Faire <a href="{{ route('login') }}">
                                            connexion</a></p>
                                </div>
                            </div>
                        </div>
