                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Paramètres</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
Groupe sanguin</label>
                                                ...
                                                @endif
                                                @if ($user->type === 'doctor')
                                                    <input class='form-control mt-3' type='text' name='specialty' placeholder="Especialite" value='{{ $user->doctor->specialty ?? '' }}'>
                                                @endif
                                                <br>
                                                <button class='btn btn-outline-primary' type='submit'>Envoie</button>
                                                <br>
                                            </form>
                                        </div>
                                    </div>
