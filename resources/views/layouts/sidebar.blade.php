        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="Dashboard" class="nav-item @yield('sidebar_dashboard')">
                    <a href="{{ route('dashboard') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Tableaux de bord</span></a>
                </li>
                <li data-username="Appointments" class="nav-item @yield('sidebar_appointments')">
                    <a href="{{ route('appointments.index') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-calendar"></i></span><span class="pcoded-mtext">
Des horaires</span></a>
                </li>
                @if ($user->type !== 'doctor')
                    <li data-username="Doctors" class="nav-item @yield('sidebar_doctors')">
                        <a href="{{ route('doctors.index') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Docteurs</span></a>
                    </li>
                @endif
                @if ($user->type === 'admin')
                    ...
                    <li data-username="Admins" class="nav-item @yield('sidebar_admins')">
                        <a href="{{ route('admins.index') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-lock"></i></span><span class="pcoded-mtext">Administrateurs</span></a>
                    </li>
                @endif
                <li data-username="Configuration" class="nav-item @yield('sidebar_config')">
                    <a href="{{ route('users.edit', $user->id) }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext">Parametres</span></a>
                </li>
